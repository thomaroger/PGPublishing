...
class TagListController extends AbstractListController
{
   /**
    ...
    */
    protected function renderBlock()
    {
        ...
        $query = $query->select('t')->from('PlaygroundPublishing\Entity\Tag', 't');
    ...
    */
    protected function getBlockMapper()
    {
        if (empty($this->blockMapper)) {
            $this->setBlockMapper($this->getServiceManager()->get('playgroundpublishing_tag_mapper'));
        }
