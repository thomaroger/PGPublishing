...
class ArticleListController extends AbstractListController
{
   /**
    ...
    */
    protected function getBlockMapper()
    {
        if (empty($this->blockMapper)) {
            $this->setBlockMapper($this->getServiceManager()->get('playgroundpublishing_article_mapper'));
        }
