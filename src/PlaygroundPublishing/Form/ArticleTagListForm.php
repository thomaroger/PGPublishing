...
class ArticleTagListForm extends BlockForm
{
    ...
    */
    protected function getTemplates()
    {
        ...
        $templates = $this->getServiceManager()->get('playgroundcms_template_service')->getTemplateMapper()->findBy(array('isSystem' => 0, 'blockType' => 'PlaygroundPublishing\Blocks\ArticleTagListController'));
