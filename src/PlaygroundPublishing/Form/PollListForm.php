...
class PollListForm extends BlockForm
{
    /**
    * {@inheritdoc}
    ...
    */
    protected function getTemplates()
    {
        ...
        $templates = $this->getServiceManager()->get('playgroundcms_template_service')->getTemplateMapper()->findBy(array('isSystem' => 0, 'blockType' => 'PlaygroundPublishing\Blocks\PollListController'));
    ...
    */
    ...
    {
        $filtersArray = array();
        $filters = array_keys($this->getServiceManager()->get('playgroundpublishing_poll_mapper')->getSupportedFilters());
    ...
    */
    ...
    {
        $sortsArray = array();
        $sorts = array_keys($this->getServiceManager()->get('playgroundpublishing_poll_mapper')->getSupportedSorts());
