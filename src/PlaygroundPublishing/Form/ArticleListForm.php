...
class ArticleListForm extends BlockForm
{
    /**
    * {@inheritdoc}
    ...
    */
    protected function getTemplates()
    {
        ...
        $templates = $this->getServiceManager()->get('playgroundcms_template_service')->getTemplateMapper()->findBy(array('isSystem' => 0, 'blockType' => 'PlaygroundPublishing\Blocks\ArticleListController'));
    ...
    */
    ...
    {
        $filtersArray = array();
        $filters = array_keys($this->getServiceManager()->get('playgroundpublishing_article_mapper')->getSupportedFilters());
