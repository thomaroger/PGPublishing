...
class TagListForm extends BlockForm
{
    /**
    * {@inheritdoc}
    ...
    */
    ...
    {
        $filtersArray = array();
        $filters = array_keys($this->getServiceManager()->get('playgroundpublishing_tag_mapper')->getSupportedFilters());
    ...
    */
    ...
    {
        $sortsArray = array();
        $sorts = array_keys($this->getServiceManager()->get('playgroundpublishing_tag_mapper')->getSupportedSorts());
