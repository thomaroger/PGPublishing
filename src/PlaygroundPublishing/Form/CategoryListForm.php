...
class CategoryListForm extends BlockForm
{
    /**
    * {@inheritdoc}
    ...
    */
    protected function getTemplates()
    {
        ...
        $templates = $this->getServiceManager()->get('playgroundcms_template_service')->getTemplateMapper()->findBy(array('isSystem' => 0, 'blockType' => 'PlaygroundPublishing\Blocks\CategoryListController'));
    ...
    */
    ...
    {
        $filtersArray = array();
        $filters = array_keys($this->getServiceManager()->get('playgroundpublishing_category_mapper')->getSupportedFilters());
    ...
    */
    ...
    {
        $sortsArray = array();
        $sorts = array_keys($this->getServiceManager()->get('playgroundpublishing_category_mapper')->getSupportedSorts());
